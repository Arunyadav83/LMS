...
<!-- <div class="container-fluid">
 ...
 <div class="container-fluid mt-5" style="background-color: rgb(242 242 242);">
    ...
    <!-- Tabs -->
    <ul class="nav nav-pills course-tabs justify-content-center mb-4" id="courseTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="programming-tab" data-bs-toggle="tab" data-bs-target="#programming" type="button" role="tab">
