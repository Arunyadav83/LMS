...
<body>
    ...
    <!-- <footer>
        <p>&copy; 2023 Ultrakey. All rights reserved.</p>
    </footer> -->
...
function joinLiveClass() {
    ...
    // Logic to join live class goes here
    window.location.href = 'https://ultrakey.in/live-classes';
}

function viewRecordedClasses() {
    alert("Viewing recorded classes...");
    // Logic to view recorded classes goes here
    window.location.href = 'https://ultrakey.in/recorded-classes';
}
    </script>
