    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-4">
                <img src="assets/images/logo.png" alt="Ultrakey Learning Logo" style="height: 60px; width: auto; max-width: 100%;">
                <div class="">
                <!-- <h5>About Ultrakey Learning</h5> -->
                <p style="margin-top: 30px;">Empowering learners worldwide with cutting-edge online education. Join us on a journey of knowledge and growth.</p>
